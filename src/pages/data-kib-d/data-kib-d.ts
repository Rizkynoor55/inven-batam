...
/**
 * Generated class for the DataKibDPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-data-kib-d',
  templateUrl: 'data-kib-d.html',
})
export class DataKibDPage {
...
load(){
   ...
   loader.present().then(() => {
   this.http.get('http://localhost/api/api.php?command=TampilKibD&kd_lokasi='+this.kode_lokasi)
   .timeout(15000)
   .map(res => res.json())
  .subscribe((success)=>{
...
CariAset(event) {
 ...
 tambah_kib_d(param)
 {
    this.navCtrl.push('TambahKibDPage',param);
 }
   ...
   let alert = this.alertCtrl.create({
      ...
      buttons: [
          ...
          },
          {
              ...
              handler: () => {
               loader.present().then(() => {
                  this.http.get('http://192.168.1.1/api/api.php?command=RbKibD&kd_lokasi='+kode_lokasi+'&id_aset='+id_aset)
                  .timeout(15000)
                  .subscribe((success)=>{
                  loader.dismiss();
                  const toast = this.toastCtrl.create({
   ...
   let alert = this.alertCtrl.create({
      ...
      buttons: [
          ...
          },
          {
              ...
              handler: () => {
               loader.present().then(() => {
                  this.http.get('http://192.168.1.1/api/api.php?command=BKibD&kd_lokasi='+kode_lokasi+'&id_aset='+id_aset)
                  .timeout(15000)
                  .subscribe((success)=>{
                  loader.dismiss();
                  const toast = this.toastCtrl.create({
   ...
   let alert = this.alertCtrl.create({
      ...
      buttons: [
          ...
          },
          {
              ...
              handler: () => {
               loader.present().then(() => {
                  this.http.get('http://192.168.1.1/api/api.php?command=VerifKibD&kd_lokasi='+kode_lokasi+'&id_aset='+id_aset+'&verifikator='+this.data_user.nama+'&tgl_verifikasi='+this.Tanggal)
                  .timeout(15000)
                  .subscribe((success)=>{
                  loader.dismiss();
                  const toast = this.toastCtrl.create({
 ...
 BatalVerifKibD(id_aset,kode_lokasi)
 {
   let alert = this.alertCtrl.create({
      ...
      buttons: [
          ...
          },
          {
              ...
              handler: () => {
               loader.present().then(() => {
                  this.http.get('http://192.168.1.1/api/api.php?command=BatalVerifKibD&kd_lokasi='+kode_lokasi+'&id_aset='+id_aset+'&verifikator='+this.data_user.nama+'&tgl_verifikasi='+this.Tanggal)
                  .timeout(15000)
                  .subscribe((success)=>{
                  loader.dismiss();
                  const toast = this.toastCtrl.create({
